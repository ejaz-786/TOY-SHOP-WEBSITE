...
import { IconButton, Modal, Snackbar, SnackbarContent, Typography } from "@mui/material";
  ...
  return (
    <div className="cart">
      {datacon.cartArr.length !== 0 ? (
        ...
        <>
          <div>
            <h1 style={{ textAlign: "center" }}>Your Bag is Empty...</h1>
            <p style={{textAlign: 'center', fontSize: '100px'}}>&#128546;</p>
            <p style={{textAlign: 'center'}}><button onClick={shop} className="gts">Go To Shop</button></p>
          </div>
        </>
      )}
